...
void main() {
  ...
  group('First-time User Onboarding Integration Tests', () {
    testWidgets('complete onboarding flow for new user', (tester) async {
      ...
      expect(
        find.text('Manage your family\'s medical records securely'),
        findsOneWidget,
      );
      ...
      expect(
        find.text(
          'Let\'s start by setting up your first family member profile',
        ),
        findsOneWidget,
      );
      ...
      await tester.tap(
        find.text('OK'),
      ); // Close date picker with default/selected date
      await tester.pumpAndSettle();
      ...
      expect(
        find.text('Add an emergency contact for this profile'),
        findsOneWidget,
      );
      expect(
      ...
      expect(
        find.byKey(const Key('add_emergency_contact_button')),
        findsOneWidget,
      );
      ...
      expect(
        find.text('Your profile has been created successfully'),
        findsOneWidget,
      );
    ...
    testWidgets('validation errors during profile creation', (tester) async {
      ...
      expect(
        find.text('Last name must be at least 2 characters'),
        findsOneWidget,
      );
    ...
    testWidgets('database encryption is initialized during onboarding', (
      tester,
    ) async {
      // Start the app
      app.main();
