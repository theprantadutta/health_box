...
void main() {
  ...
  group('LoggingService', () {
    ...
    group('logging methods', () {
      test('should log trace messages', () async {
        ...
        expect(
          testLogWriter.entries.first.message,
          equals('Test trace message'),
        );
  ...
  group('Global logger functions', () {
    test('should use global logger instance', () async {
      ...
      expect(
        globalTestWriter.entries.first.message,
        equals('Global info message'),
      );
      expect(
        globalTestWriter.entries.last.message,
        equals('Global error message'),
      );
    });
  });
}
