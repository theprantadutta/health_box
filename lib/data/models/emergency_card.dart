...
class EmergencyCards extends Table {
  ...
  TextColumn get criticalAllergies =>
      text().named('critical_allergies')(); // JSON array
  TextColumn get currentMedications =>
      text().named('current_medications')(); // JSON array
  TextColumn get medicalConditions =>
      text().named('medical_conditions')(); // JSON array
  TextColumn get emergencyContact =>
      text().nullable().named('emergency_contact')();
  TextColumn get secondaryContact =>
      text().nullable().named('secondary_contact')();
  TextColumn get insuranceInfo => text().nullable().named('insurance_info')();
  TextColumn get additionalNotes =>
      text().nullable().named('additional_notes')();
  DateTimeColumn get lastUpdated =>
      dateTime().withDefault(currentDateAndTime).named('last_updated')();
