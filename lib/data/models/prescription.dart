...
class Prescriptions extends Table {
  ...
  TextColumn get recordType => text().withDefault(const Constant('prescription')).named('record_type')();
  ...
  TextColumn get prescribingDoctor => text().nullable().named('prescribing_doctor')();
  ...
  IntColumn get refillsRemaining => integer().nullable().named('refills_remaining')();
  BoolColumn get isPrescriptionActive => boolean().withDefault(const Constant(true)).named('is_prescription_active')();
